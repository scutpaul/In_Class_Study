...
void mythread_init(long period,int priority);//修改
int  mythread_create(mythread_t *thread, int priority,void *(*start_routine)(void *), void *arg);//修改
...
void show_all_thread();  //debug用,也可删除
